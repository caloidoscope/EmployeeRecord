...
class CreateModal extends Component {
    ...
    render() {
        ...
        const isFirstNameEmpty = newFirstName == "" || newFirstName == null
        const isMiddleNameEmpty = newMiddleName == "" || newMiddleName == null
        const isLastNameEmpty = newLastName == "" || newLastName == null
            ...
            <div>
                ...
                >
                    <Box component="form" sx={style}>
                        <h2 id="unstyled-modal-title">Create Employee</h2>
                        <Grid item md={12}>
...
const mapDispatchToProps = dispatch => {
    return {
        createEmployee: (employee) => actionTypes.createEmployee(dispatch, employee),
        unsetCurrentEmployee: () => dispatch(actionTypes.unsetCurrentEmployee())
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(CreateModal));